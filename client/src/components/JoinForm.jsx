...
function JoinForm() {
  ...
  const Api = 'https://umuahia-blog-3.onrender.com/api/youth'; 
  ...
  return (
    <>
      {/* Floating Trigger Button - Only show when form is not open */}
      {!showForm && (
      ...
      {/* Centered Modal Overlay - Shown when form is open */}
      {showForm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fadeIn">
          ...
          <div className="relative w-full max-w-md animate-slideUp">
            ...
            {/* Main Modal Content */}
            <div className="bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl border border-green-100 relative overflow-hidden">
              ...
              {/* Form */}
              <form onSubmit={handleSubmit} className="p-6 pt-2 space-y-4 max-h-[calc(90vh-8rem)] overflow-y-auto">
                <input
                  name="fullName"
